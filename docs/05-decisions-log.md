...
| 2026-07-02 | Updated no-auth spots UX with image-based galleries (icon-only preview affordance + lightbox), reorganized spot assets under `app/static/images/spots`, and converted landing hero visual into a smooth rotating slideshow | app/src/routes/spots/+page.svelte, app/src/routes/+page.svelte, app/static/images/spots/* |
